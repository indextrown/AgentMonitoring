...
describe('task state machine', () => {
  it('allows the guarded implementation and approval flow', () => {
    ...
    expect(canTransition('running', 'blocked_agent')).toBe(true)
    expect(canTransition('testing', 'blocked_agent')).toBe(true)
    expect(canTransition('blocked_agent', 'running')).toBe(true)
